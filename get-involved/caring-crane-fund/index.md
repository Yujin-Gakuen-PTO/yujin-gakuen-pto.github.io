---
layout: feature
title: Caring Crane Fund
permalink: /get-involved/caring-crane-fund/
...
<section class="crane-help" aria-labelledby="crane-help-title">
  <div class="section-heading section-heading--center">
    <p class="eyebrow">Practical assistance</p>
    <h2 id="crane-help-title">What can the Caring Crane Fund help with?</h2>
...
<section id="access-support" class="access-support" aria-labelledby="access-support-title">
  <div>
    <p class="eyebrow">Requesting assistance</p>
    <h2 id="access-support-title">How to access support</h2>
    <p>If you are a family in need of support, please reach out to Kocho-Sensei Kimberly Ingram, Brigitte Phipps, Scott Klein, or your teachers. Your request will remain confidential.</p>
  </div>
  <ul class="contact-list">
    <li><strong>Kimberly Ingram, Kocho-Sensei</strong><a href="mailto:ingram_k@4j.lane.edu">ingram_k@4j.lane.edu</a></li>
    <li><strong>Brigitte Phipps</strong><a href="mailto:phipps_b@4j.lane.edu">phipps_b@4j.lane.edu</a></li>
    <li><strong>Scott Klein</strong><a href="mailto:klein_s@4j.lane.edu">klein_s@4j.lane.edu</a></li>
  </ul>
</section>
...
<section class="crane-donate" aria-labelledby="crane-donate-title">
  ...
  <div class="crane-donate__actions">
    <a class="button button--primary" href="{{ site.data.links.caring_crane.url }}">Donate to the Caring Crane Fund</a>
  </div>
</section>
