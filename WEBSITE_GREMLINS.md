...
| Page or component | Type | Description | Owner | Severity | Blocks Comms review? | Blocks public launch? |
| --- | --- | --- | --- | --- | --- | --- |
| Staff Hub | IMAGE NEEDED | Add `assets/images/staff-hub-reference-4x3.jpg` at 1200 x 900 px. Purpose: staff/PTO reference detail, workspace, or non-identifying school-community support image. | Hannah / Comms | minor | no | no |
| Caring Crane Fund | REVIEW | Hero and body now use the available crane artwork and guide-inspired structure; review whether a separate body illustration is still needed after Hannah sees the page. | Hannah / Comms | minor | no | no |
| Obon & Taiko Festival | IMAGE NEEDED | Add `assets/images/obon-taiko-festival-atmosphere-16x9.jpg` at 1600 x 900 px. Purpose: festival atmosphere, lanterns, taiko, or children's-section setup. | Hannah / Event committee | minor | no | no |
| Jikyuso | IMAGE NEEDED | Add `assets/images/jikyuso-campaign-detail-4x3.jpg` at 1200 x 900 px. Purpose: small running, reading, or campaign detail without identifiable student faces. | Staff / Hannah | minor | no | no |
| Teacher & Staff Appreciation | IMAGE NEEDED | Add `assets/images/staff-appreciation-detail-4x3.jpg` at 1200 x 900 px. Purpose: thank-you notes, appreciation supplies, flowers, or staff-care detail. | Hannah / Comms | minor | no | no |
| Field Day | IMAGE NEEDED | Add `assets/images/field-day-schoolyard-detail-4x3.jpg` at 1200 x 900 px. Purpose: small outdoor activity setup or field-day detail without identifiable student faces. | Staff / Hannah | minor | no | no |
...
| Field Day | CONTENT SOURCE NEEDED | Date, location, grade schedule, student instructions, accessibility information, volunteer roles, signup link, and event contact are still needed. | Staff / Hannah | moderate | no | yes |
